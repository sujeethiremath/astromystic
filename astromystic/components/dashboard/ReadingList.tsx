          ...
          <div key={reading.id} className={`group rounded-xl overflow-hidden border transition-all hover:shadow-xl ${currentStyles.panelBg} ${currentStyles.border}`}>
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-2">
                <h3 className="font-serif text-lg font-bold truncate pr-2">{reading.title}</h3>
                {reading.status === 'ready' && <Star className="w-4 h-4 text-yellow-500 fill-yellow-500 flex-shrink-0" />}
              </div>
