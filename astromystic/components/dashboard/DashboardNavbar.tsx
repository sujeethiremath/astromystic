...
export default function DashboardNavbar({
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 border-b backdrop-blur-md ${currentStyles.nav}`}
    >
          ...
          <div className="flex items-center gap-4">
            ...
            {user && (
              <div className="flex items-center gap-3 pl-4 border-l border-current border-opacity-20">
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${currentStyles.accent}`}
                >
