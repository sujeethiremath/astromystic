...
export default function Navbar({
  ...
  return (
    ...
    >
          ...
          >
            ...
            <div className="flex flex-col -space-y-1">
              <div className="flex items-baseline">
                ...
                <span
                  className="text-3xl font-normal mr-1 opacity-90"
      ...
      {isMenuOpen && (
        <div
          className={`md:hidden fixed inset-0 top-16 ${currentStyles.navBg} backdrop-blur-xl border-t border-opacity-10 border-current h-[calc(100vh-4rem)] flex flex-col p-6 space-y-6 animate-in slide-in-from-right-10 fade-in duration-200`}
        >
