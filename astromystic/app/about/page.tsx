...
export default function AboutPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      details: ['Live interaction', 'Requires: Birth data for BOTH people'],
      highlight: true,
    },
    {
  ...
  return (
    ...
    >
      ...
      <Navbar
        ...
        onOpenAuth={() => {
          trackEvent('Auth Modal Opened', { source: 'About Page Navbar' });
          ...
          <section className="text-center space-y-8">
            ...
            <div className="flex justify-center items-center gap-6 animate-fade-in">
              ...
              <div className="flex flex-col items-center gap-2 pr-6 border-r-2 border-current border-opacity-40 py-2">
                <Sun
                  className={`w-8 h-8 ${theme === 'sun' ? 'text-amber-500' : 'text-indigo-300'} opacity-90`}
                />
                <div className="relative w-8 h-8">
                  <Moon
                    className={`w-8 h-8 ${theme === 'sun' ? 'text-amber-600' : 'text-indigo-400'} opacity-90`}
                  />
                  <Star
                    className={`absolute -top-1 -right-2 w-4 h-4 fill-current ${theme === 'sun' ? 'text-amber-400' : 'text-indigo-200'} opacity-90`}
                  />
                </div>
                <Star
                  className={`w-8 h-8 ${theme === 'sun' ? 'text-amber-700' : 'text-indigo-500'} opacity-90`}
                />
              </div>
              ...
              <div className="flex flex-col -space-y-2 text-left">
                <div className="flex items-baseline">
                  <span
                    className="text-5xl md:text-7xl font-normal mr-2 opacity-90"
            ...
            <p className="text-lg md:text-xl opacity-80 max-w-2xl mx-auto leading-relaxed">
              Astrology is an ancient symbolic system that studies the
              relationship between celestial movements and human experience.
            </p>
          </section>

          {/* SECTION 2: WHAT IS ASTROLOGY */}
          <section
            className={`p-8 rounded-2xl border ${current.cardBg} ${current.cardBorder}`}
          >
            ...
            <div className="space-y-4 opacity-90 leading-relaxed">
              <p>
                It is based on the idea that the positions of the planets and
                stars at any given moment reflect patterns that can describe
                personality, life themes, timing, and the dynamics between
                people and events.
              </p>
              <p>
                There are various types of systems in astrology, such as
                aspects, sidereal system of astrology, western, as well as chart
                systems. Astrology is a very practical tool you can utilize in
                your life to navigate through life challenges, make plans, or
                adjust them by using <strong>transits</strong>.
              </p>
              <p>
                It allows you to learn your psychological makeup, understand
                yourself on a deeper level, uncover your potential, tap into
                your gifts, and choose the best career path while becoming aware
                of what to avoid.
              </p>
            </div>
          </section>
          ...
          <section className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="opacity-80 leading-relaxed">
                Used for relationship guidance to help you pick the partner who
                aligns with your vision. We put one chart on top of another to
                see how two people's planets interact with each other (7th house
                astrology).
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="opacity-80 leading-relaxed">
                A chart based on the midpoints of two people's charts. It
                generates a single chart that represents the relationship itself
                as if it were a person. It is often best to combine this with
                Synastry.
              </p>
            </div>
          </section>
              ...
              {services.map((service, idx) => (
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className={`text-lg font-bold ${current.accent}`}>
                      {service.price}
                    </span>
                  </div>
                  ...
                  <div className="mt-auto pt-4 border-t border-current border-opacity-10">
                    <div className="text-xs font-bold opacity-50 mb-2 uppercase">
                      Requirements
                    </div>
                    <ul className="space-y-1 text-sm opacity-70">
                      {service.details.map((detail, i) => (
                        <li key={i} className="flex items-start gap-2">
                          <span
                            className={`mt-1.5 w-1 h-1 rounded-full ${theme === 'sun' ? 'bg-amber-400' : 'bg-indigo-400'}`}
                          />
                          {detail}
                        </li>
                      ))}
      ...
      >
        <a
          ...
          onClick={() =>
            trackEvent('Powered By Link Clicked', { location: 'About Page' })
          }
        >
